...
if args.adversarial:
    ...
    if args.condition_transfer is None:
        total_results = {'epochs': [], 'loss':[], 'classification':[], 'bbox_regression':[], 'bbox_ctrness':[], 'condition':[], 'condition_adv':[], 'map':[], 'map_small':[], 'map_medium':[], 'map_large':[], 'map_50':[], 'map_75':[]}
else:
    total_results = {'epochs': [], 'loss':[], 'classification':[], 'bbox_regression':[], 'bbox_ctrness':[], 'map':[], 'map_small':[], 'map_medium':[], 'map_large':[], 'map_50':[], 'map_75':[]}
    if args.condition_transfer is not None:
        total_results = {'epochs': [], 'loss':[], 'classification':[], 'bbox_regression':[], 'bbox_ctrness':[], 'condition_transfer':[], 'map':[], 'map_small':[], 'map_medium':[], 'map_large':[], 'map_50':[], 'map_75':[]}
